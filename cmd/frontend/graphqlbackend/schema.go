...
# A discussion thread target. Exactly 1 field must be set (for the type of target to add).
input DiscussionThreadTargetInput {
    # Add a repo target.
    repo: DiscussionThreadTargetRepoInput
}
...
type DiscussionThreadTargetRepo {
    # The discussion thread target ID (globally unique).
    id: ID!
